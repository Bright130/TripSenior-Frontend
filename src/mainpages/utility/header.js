        ...
        <div className="header-1-3-1">
          <div className="header-1-3-1-0">
            <div className="header-1-3-1-0-0">
              <div
                className="header-my_trips_-6"
                onClick={reactComponent.goMyTrip.bind(reactComponent)}
              >
                My Trips
              </div>
            </div>
          ...
          <div className="header-1-5">
            ...
            <div
              className="header-1-5-1"
              onClick={reactComponent.goProfile.bind(reactComponent)}
            >
              <img
